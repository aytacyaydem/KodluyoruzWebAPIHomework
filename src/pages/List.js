...
function List({route}) {
    ...
    return (
        <View style={{flex:1,justifyContent:"center",alignItems:"center",backgroundColor:"#cbba83"}}>
            <View>
            <FlatList data={meals} renderItem={renderItem} keyExtractor={item => item.idMeal.toString()} horizontal showsHorizontalScrollIndicator={false} />
            </View>
